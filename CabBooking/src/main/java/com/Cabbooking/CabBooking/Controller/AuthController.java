...
public class AuthController
{
	...
	{
		if(authService.emailValidation(emailOtpRequest.getEmail())) {
	...
	public ResponseEntity<Object> createUser(@RequestBody Customer customerDetails){
		...
		if(fetchCustomer == null) {
			if (authService.emailValidation(customerDetails.getEmail())) {
	...
	public ResponseEntity<Object> createDriver(@RequestBody CabDriver driverDetials)
		...
		if(fetchDriver == null) {
			if (authService.emailValidation(driverDetials.getEmail())) {
